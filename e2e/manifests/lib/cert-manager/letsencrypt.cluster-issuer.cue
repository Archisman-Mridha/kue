...
import clusterIssuerV1 "cert-manager.io/clusterissuer/v1"
...
#CertManager: {
  ...
  // the secretName field, secrets will be looked for in the Cluster Resource Namespace. By default,
  // this namespace is CertManager.
